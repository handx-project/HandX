...
# import chamfer_distance as chd  # Not used in encode.py
...
def calculate_diversity(activation, diversity_times, seed=42, use_fixed_indices=True):
    ...
    # Try to use pre-generated fixed indices for reproducibility
    if use_fixed_indices:
        try:
            # Try loading from BihandMotionAutoAnno projects
            import os
            ...
            if fixed_indices_path is not None:
                ...
                # Check if the fixed indices match our requirements
            ...
            # If loading fails, fall back to random generation
            pass

    # Fallback: use random seed for reproducibility
