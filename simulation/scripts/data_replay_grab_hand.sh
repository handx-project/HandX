...
MOTION_FILE=${1:-custom_mano}
MOTION_BASENAME=$(basename $MOTION_FILE .pt)
OUTPUT=${2:-hand_replay_${MOTION_BASENAME}.mp4}
CUDA_LAUNCH_BLOCKING=1 python intermimic/run.py --task HandReplay --cfg_env intermimic/data/cfg/grab_hand.yaml --cfg_train intermimic/data/cfg/train/rlg/grab_hand.yaml --test --play_dataset --num_envs 1 --save_images --motion_file $MOTION_FILE

# Remove frame 0 (always a static/init frame)
